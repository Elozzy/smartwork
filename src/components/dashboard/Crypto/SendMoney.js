...
import { TransferHistory } from 'util/functions/user';
...
const columns = [
  {
    ...
    render: (text, record) => {
      return <div className="gx-flex-row gx-align-items-center">
        <img className="gx-rounded-circle gx-size-30 gx-mr-2" src={text} alt={record.key}/>
...
const data = (!TransferHistory()) ? []: TransferHistory();
